...
var sci$impl$types$IBox$setVal$dyn_62573 = (function (_this,_v){
...
return sci$impl$types$IBox$setVal$dyn_62573(_this,_v);
}
});

var sci$impl$types$IBox$getVal$dyn_62576 = (function (_this){
var x__4550__auto__ = (((_this == null))?null:_this);
...
return sci$impl$types$IBox$getVal$dyn_62576(_this);
}
});
...
var sci$impl$types$IReified$getInterfaces$dyn_62582 = (function (_){
...
return sci$impl$types$IReified$getInterfaces$dyn_62582(_);
}
});

var sci$impl$types$IReified$getMethods$dyn_62583 = (function (_){
var x__4550__auto__ = (((_ == null))?null:_);
...
return sci$impl$types$IReified$getMethods$dyn_62583(_);
}
});

var sci$impl$types$IReified$getProtocols$dyn_62584 = (function (_){
var x__4550__auto__ = (((_ == null))?null:_);
...
return sci$impl$types$IReified$getProtocols$dyn_62584(_);
}
});
...
var sci$impl$types$SciTypeInstance$_get_type$dyn_62587 = (function (_){
var x__4550__auto__ = (((_ == null))?null:_);
...
return sci$impl$types$SciTypeInstance$_get_type$dyn_62587(_);
}
});

var sci$impl$types$SciTypeInstance$_mutate$dyn_62589 = (function (_,k,v){
var x__4550__auto__ = (((_ == null))?null:_);
...
return sci$impl$types$SciTypeInstance$_mutate$dyn_62589(_,k,v);
}
});

sci.impl.types.type_impl = (function sci$impl$types$type_impl(var_args){
var args__4870__auto__ = [];
var len__4864__auto___62591 = arguments.length;
var i__4865__auto___62592 = (0);
while(true){
if((i__4865__auto___62592 < len__4864__auto___62591)){
args__4870__auto__.push((arguments[i__4865__auto___62592]));

var G__62593 = (i__4865__auto___62592 + (1));
i__4865__auto___62592 = G__62593;
continue;
} else {
}
break;
...
var or__4253__auto____$2 = (function (){var G__62479 = x;
var G__62479__$1 = (((G__62479 == null))?null:cljs.core.meta(G__62479));
if((G__62479__$1 == null)){
return null;
} else {
return new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(G__62479__$1);
}
})();
...
/** @this {Function} */
(sci.impl.types.type_impl.cljs$lang$applyTo = (function (seq62474){
var G__62475 = cljs.core.first(seq62474);
var seq62474__$1 = cljs.core.next(seq62474);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__62475,seq62474__$1);
}));
...
var sci$impl$types$Stack$stack$dyn_62594 = (function (this$){
...
return sci$impl$types$Stack$stack$dyn_62594(this$);
}
});
...
(sci.impl.types.NodeR.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4504__auto__,k62493,else__4505__auto__){
var self__ = this;
var this__4504__auto____$1 = this;
var G__62500 = k62493;
var G__62500__$1 = (((G__62500 instanceof cljs.core.Keyword))?G__62500.fqn:null);
switch (G__62500__$1) {
case "f":
return self__.f;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k62493,else__4505__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4525__auto__,p__62504){
var vec__62505 = p__62504;
var k__4526__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62505,(0),null);
var v__4527__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62505,(1),null);
...
(sci.impl.types.NodeR.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__62492){
var self__ = this;
var G__62492__$1 = this;
return (new cljs.core.RecordIter((0),G__62492__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"f","f",-1597136552),new cljs.core.Keyword(null,"stack","stack",-793405930)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(sci.impl.types.NodeR.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this62494,other62495){
var self__ = this;
var this62494__$1 = this;
return (((!((other62495 == null)))) && ((((this62494__$1.constructor === other62495.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this62494__$1.f,other62495.f)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this62494__$1.stack,other62495.stack)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this62494__$1.__extmap,other62495.__extmap)))))))));
}));
...
(sci.impl.types.NodeR.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4509__auto__,k62493){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k62493);

}
}));

(sci.impl.types.NodeR.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4510__auto__,k__4511__auto__,G__62492){
var self__ = this;
var this__4510__auto____$1 = this;
var pred__62525 = cljs.core.keyword_identical_QMARK_;
var expr__62526 = k__4511__auto__;
if(cljs.core.truth_((pred__62525.cljs$core$IFn$_invoke$arity$2 ? pred__62525.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"f","f",-1597136552),expr__62526) : pred__62525.call(null,new cljs.core.Keyword(null,"f","f",-1597136552),expr__62526)))){
return (new sci.impl.types.NodeR(G__62492,self__.stack,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__62525.cljs$core$IFn$_invoke$arity$2 ? pred__62525.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"stack","stack",-793405930),expr__62526) : pred__62525.call(null,new cljs.core.Keyword(null,"stack","stack",-793405930),expr__62526)))){
return (new sci.impl.types.NodeR(self__.f,G__62492,self__.__meta,self__.__extmap,null));
} else {
return (new sci.impl.types.NodeR(self__.f,self__.stack,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4511__auto__,G__62492),null));
}
}
}));
...
(sci.impl.types.NodeR.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4501__auto__,G__62492){
var self__ = this;
var this__4501__auto____$1 = this;
return (new sci.impl.types.NodeR(self__.f,self__.stack,G__62492,self__.__extmap,self__.__hash));
}));
 ...
 */
sci.impl.types.map__GT_NodeR = (function sci$impl$types$map__GT_NodeR(G__62497){
var extmap__4542__auto__ = (function (){var G__62556 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__62497,new cljs.core.Keyword(null,"f","f",-1597136552),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"stack","stack",-793405930)], 0));
if(cljs.core.record_QMARK_(G__62497)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__62556);
} else {
return G__62556;
}
})();
return (new sci.impl.types.NodeR(new cljs.core.Keyword(null,"f","f",-1597136552).cljs$core$IFn$_invoke$arity$1(G__62497),new cljs.core.Keyword(null,"stack","stack",-793405930).cljs$core$IFn$_invoke$arity$1(G__62497),null,cljs.core.not_empty(extmap__4542__auto__),null));
});

sci.impl.types.eval = (function sci$impl$types$eval(expr,ctx,bindings){
if((expr instanceof sci.impl.types.NodeR)){
var fexpr__62560 = expr.f;
return (fexpr__62560.cljs$core$IFn$_invoke$arity$3 ? fexpr__62560.cljs$core$IFn$_invoke$arity$3(expr,ctx,bindings) : fexpr__62560.call(null,expr,ctx,bindings));
} else {
return expr;
}
});
...
var sci$impl$types$HasName$getName$dyn_62632 = (function (_){
var x__4550__auto__ = (((_ == null))?null:_);
...
return sci$impl$types$HasName$getName$dyn_62632(_);
}
});
