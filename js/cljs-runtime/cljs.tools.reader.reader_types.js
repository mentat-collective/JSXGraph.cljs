...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_51312 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_51312(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_51313 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_51313(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_51317 = (function (reader,ch){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_51317(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_51324 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_51324(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_51325 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_51325(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_51326 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_51326(reader);
}
});
...
var G__51510 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__51511 = s.append(c);
c = G__51510;
s = G__51511;
continue;
}
