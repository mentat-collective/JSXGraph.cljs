...
nextjournal.devcards.register_devcard_STAR_ = (function nextjournal$devcards$register_devcard_STAR_(p__66534){
var map__66535 = p__66534;
var map__66535__$1 = cljs.core.__destructure_map(map__66535);
var opts = map__66535__$1;
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66535__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
...
var vec__66541 = temp__5751__auto__;
var e = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__66541,(0),null);
var info = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__66541,(1),null);
...
nextjournal.devcards.testview = reagent.core.create_class.cljs$core$IFn$_invoke$arity$1(cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"render","render",-1408033454),nextjournal.view.wrap_render((function nextjournal$devcards$testview(p__66546){
var map__66547 = p__66546;
var map__66547__$1 = cljs.core.__destructure_map(map__66547);
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66547__$1,new cljs.core.Keyword("nextjournal.view","state","nextjournal.view/state",-1424072930));
...
nextjournal.devcards.testc = reagent.core.create_class.cljs$core$IFn$_invoke$arity$1(cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"render","render",-1408033454),nextjournal.view.wrap_render((function nextjournal$devcards$testc(p__66551){
var map__66552 = p__66551;
var map__66552__$1 = cljs.core.__destructure_map(map__66552);
var dispatch = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66552__$1,new cljs.core.Keyword("re-frame.context","dispatch","re-frame.context/dispatch",1850204165));
var subscribe = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66552__$1,new cljs.core.Keyword("re-frame.context","subscribe","re-frame.context/subscribe",-119266480));
...
var G__66553 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("nextjournal.devcards","inc","nextjournal.devcards/inc",1768266442)], null);
return (dispatch.cljs$core$IFn$_invoke$arity$1 ? dispatch.cljs$core$IFn$_invoke$arity$1(G__66553) : dispatch.call(null,G__66553));
})], null),"Counter = ",cljs.core.deref((function (){var G__66554 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("nextjournal.devcards","counter","nextjournal.devcards/counter",1209240473)], null);
return (subscribe.cljs$core$IFn$_invoke$arity$1 ? subscribe.cljs$core$IFn$_invoke$arity$1(G__66554) : subscribe.call(null,G__66554));
})())], null);
...
nextjournal.devcards.frame_display = reagent.core.create_class.cljs$core$IFn$_invoke$arity$1(cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"render","render",-1408033454),nextjournal.view.wrap_render((function nextjournal$devcards$frame_display(p__66556){
var map__66557 = p__66556;
var map__66557__$1 = cljs.core.__destructure_map(map__66557);
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66557__$1,new cljs.core.Keyword("nextjournal.view","state","nextjournal.view/state",-1424072930));
...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_frame.context.provide_frame,frame,(function (){var _STAR_current_frame_STAR__orig_val__66558 = re_frame.registry._STAR_current_frame_STAR_;
var _STAR_current_frame_STAR__temp_val__66559 = frame;
(re_frame.registry._STAR_current_frame_STAR_ = _STAR_current_frame_STAR__temp_val__66559);
...
}finally {(re_frame.registry._STAR_current_frame_STAR_ = _STAR_current_frame_STAR__orig_val__66558);
}})()], null);
