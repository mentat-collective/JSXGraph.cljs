...
var arg_count_68097 = (cljs.core.count(expr) - (1));
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((2),arg_count_68097)){
} else {
sci.impl.utils.throw_error_with_location.cljs$core$IFn$_invoke$arity$2(["Wrong number of args (",cljs.core.str.cljs$core$IFn$_invoke$arity$1(arg_count_68097),") passed to: clojure.core/for"].join(''),expr);
}
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (groups,p__67953){
...
var err = (function() { 
var G__68098__delegate = function (msg){
throw (new Error(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,msg)));
};
var G__68098 = function (var_args){
var msg = null;
if (arguments.length > 0) {
var G__68099__i = 0, G__68099__a = new Array(arguments.length -  0);
while (G__68099__i < G__68099__a.length) {G__68099__a[G__68099__i] = arguments[G__68099__i + 0]; ++G__68099__i;}
  msg = new cljs.core.IndexedSeq(G__68099__a,0,null);
} 
return G__68098__delegate.call(this,msg);};
G__68098.cljs$lang$maxFixedArity = 0;
G__68098.cljs$lang$applyTo = (function (arglist__68100){
var msg = cljs.core.seq(arglist__68100);
return G__68098__delegate(msg);
});
G__68098.cljs$core$IFn$_invoke$arity$variadic = G__68098__delegate;
return G__68098;
})()
;
var emit_bind = (function sci$impl$for_macro$expand_for_$_emit_bind(p__67957){
var vec__67958 = p__67957;
...
var vec__67961 = first__67960;
var seq__67962 = cljs.core.seq(vec__67961);
var first__67963 = cljs.core.first(seq__67962);
var seq__67962__$1 = cljs.core.next(seq__67962);
var bind = first__67963;
var first__67963__$1 = cljs.core.first(seq__67962__$1);
var seq__67962__$2 = cljs.core.next(seq__67962__$1);
var expr__$1 = first__67963__$1;
var mod_pairs = seq__67962__$2;
var vec__67964 = seq__67959__$1;
var vec__67967 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67964,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67967,(0),null);
var next_expr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67967,(1),null);
var next_groups = vec__67964;
...
var do_mod = (function sci$impl$for_macro$expand_for_$_emit_bind_$_do_mod(p__67970){
var vec__67971 = p__67970;
var seq__67972 = cljs.core.seq(vec__67971);
var first__67973 = cljs.core.first(seq__67972);
var seq__67972__$1 = cljs.core.next(seq__67972);
var vec__67974 = first__67973;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67974,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67974,(1),null);
var pair = vec__67974;
var etc = seq__67972__$1;
...
if(next_groups){
return cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","let","cljs.core/let",-308701135,null),null,(1),null)),(new cljs.core.List(null,cljs.core.vec(cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,new cljs.core.Symbol(null,"iterys__67945__auto__","iterys__67945__auto__",-1385935909,null),null,(1),null)),(new cljs.core.List(null,sci$impl$for_macro$expand_for_$_emit_bind(next_groups),null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,new cljs.core.Symbol(null,"fs__67946__auto__","fs__67946__auto__",-805288821,null),null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","seq","cljs.core/seq",-1649497689,null),null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,new cljs.core.Symbol(null,"iterys__67945__auto__","iterys__67945__auto__",-1385935909,null),null,(1),null)),(new cljs.core.List(null,next_expr,null,(1),null))))),null,(1),null))))),null,(1),null))], 0))))),null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,new cljs.core.Symbol(null,"if","if",1181717262,null),null,(1),null)),(new cljs.core.List(null,new cljs.core.Symbol(null,"fs__67946__auto__","fs__67946__auto__",-805288821,null),null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","concat","cljs.core/concat",-1133584918,null),null,(1),null)),(new cljs.core.List(null,new cljs.core.Symbol(null,"fs__67946__auto__","fs__67946__auto__",-805288821,null),null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,giter,null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","rest","cljs.core/rest",-285075455,null),null,(1),null)),(new cljs.core.List(null,gxs,null,(1),null))))),null,(1),null))))),null,(1),null))], 0)))),null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,sci.impl.utils.allowed_recur,null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","rest","cljs.core/rest",-285075455,null),null,(1),null)),(new cljs.core.List(null,gxs,null,(1),null))))),null,(1),null))))),null,(1),null))], 0)))),null,(1),null))], 0))));
} else {
...
var do_cmod = (function sci$impl$for_macro$expand_for_$_emit_bind_$_do_cmod(p__67981){
var vec__67982 = p__67981;
var seq__67983 = cljs.core.seq(vec__67982);
var first__67984 = cljs.core.first(seq__67983);
var seq__67983__$1 = cljs.core.next(seq__67983);
var vec__67985 = first__67984;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67985,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67985,(1),null);
var pair = vec__67985;
var etc = seq__67983__$1;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(k,new cljs.core.Keyword(null,"let","let",-1282412701))){
