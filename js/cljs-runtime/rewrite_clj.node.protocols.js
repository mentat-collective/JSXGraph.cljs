...
var rewrite_clj$node$protocols$Node$tag$dyn_68112 = (function (node){
...
return rewrite_clj$node$protocols$Node$tag$dyn_68112(node);
}
});

var rewrite_clj$node$protocols$Node$node_type$dyn_68125 = (function (node){
var x__4550__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$node_type$dyn_68125(node);
}
});

var rewrite_clj$node$protocols$Node$printable_only_QMARK_$dyn_68140 = (function (node){
var x__4550__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$printable_only_QMARK_$dyn_68140(node);
}
});

var rewrite_clj$node$protocols$Node$sexpr_STAR_$dyn_68142 = (function (node,opts){
var x__4550__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$sexpr_STAR_$dyn_68142(node,opts);
}
});

var rewrite_clj$node$protocols$Node$length$dyn_68146 = (function (node){
var x__4550__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$length$dyn_68146(node);
}
});

var rewrite_clj$node$protocols$Node$string$dyn_68147 = (function (node){
var x__4550__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$string$dyn_68147(node);
}
});
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__67869_SHARP_){
return rewrite_clj.node.protocols.sexpr.cljs$core$IFn$_invoke$arity$2(p1__67869_SHARP_,opts);
...
var rewrite_clj$node$protocols$InnerNode$inner_QMARK_$dyn_68156 = (function (node){
var x__4550__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$InnerNode$inner_QMARK_$dyn_68156(node);
}
});

var rewrite_clj$node$protocols$InnerNode$children$dyn_68158 = (function (node){
var x__4550__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$InnerNode$children$dyn_68158(node);
}
});

var rewrite_clj$node$protocols$InnerNode$replace_children$dyn_68160 = (function (node,children){
var x__4550__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$InnerNode$replace_children$dyn_68160(node,children);
}
});

var rewrite_clj$node$protocols$InnerNode$leader_length$dyn_68161 = (function (node){
var x__4550__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$InnerNode$leader_length$dyn_68161(node);
}
});
...
var rewrite_clj$node$protocols$NodeCoerceable$coerce$dyn_68169 = (function (form){
...
return rewrite_clj$node$protocols$NodeCoerceable$coerce$dyn_68169(form);
}
});
...
var rewrite_clj$node$protocols$MapQualifiable$map_context_apply$dyn_68170 = (function (node,map_qualifier){
var x__4550__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$MapQualifiable$map_context_apply$dyn_68170(node,map_qualifier);
}
});

var rewrite_clj$node$protocols$MapQualifiable$map_context_clear$dyn_68173 = (function (node){
var x__4550__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$MapQualifiable$map_context_clear$dyn_68173(node);
}
});
...
var map__68042 = cljs.core.meta(node);
var map__68042__$1 = cljs.core.__destructure_map(map__68042);
var row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68042__$1,new cljs.core.Keyword(null,"row","row",-570139521));
var col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68042__$1,new cljs.core.Keyword(null,"col","col",-1959363084));
var next_row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68042__$1,new cljs.core.Keyword(null,"next-row","next-row",-408963777));
var next_col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68042__$1,new cljs.core.Keyword(null,"next-col","next-col",601697889));
...
rewrite_clj.node.protocols._PLUS_extent = (function rewrite_clj$node$protocols$_PLUS_extent(p__68064,p__68065){
var vec__68072 = p__68064;
var row = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68072,(0),null);
var col = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68072,(1),null);
var vec__68075 = p__68065;
var row_extent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68075,(0),null);
var col_extent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68075,(1),null);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(row + row_extent),(function (){var G__68085 = col_extent;
if((row_extent === (0))){
return (G__68085 + col);
} else {
return G__68085;
...
if(cljs.core.truth_(rewrite_clj.node.protocols.inner_QMARK_(node))){
var G__68096 = rewrite_clj.node.protocols.children(node);
var G__68096__$1 = (((G__68096 == null))?null:cljs.core.first(G__68096));
if((G__68096__$1 == null)){
return null;
} else {
return cljs.core.juxt.cljs$core$IFn$_invoke$arity$2(rewrite_clj.node.protocols.tag,rewrite_clj.node.protocols.sexpr)(G__68096__$1);
}
} else {
