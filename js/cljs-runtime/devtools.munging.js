...
var o56878 = temp__5751__auto__;
var temp__5751__auto____$1 = (o56878["core"]);
if(cljs.core.truth_(temp__5751__auto____$1)){
var o56879 = temp__5751__auto____$1;
return (o56879["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__56324__auto__ = f;
return (o__56324__auto__["toString"]).call(o__56324__auto__);
} else {
return "";
}
}catch (e56888){var _ = e56888;
return "";
}});
...
try{var o__56324__auto___57210 = t;
(o__56324__auto___57210["cljs$lang$ctorPrWriter"]).call(o__56324__auto___57210,t,writer);
}catch (e56897){var __57211 = e56897;
}
...
var char_code = (function (){var o__56324__auto__ = (new String(char$));
return (o__56324__auto__["charCodeAt"]).call(o__56324__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__56324__auto__ = String;
return (o__56324__auto__["fromCharCode"]).call(o__56324__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__56912 = num_code;
switch (G__56912) {
case (1):
return (185);
...
var o__56324__auto__ = String;
return (o__56324__auto__["fromCharCode"]).call(o__56324__auto__,superscript_code);
});
/**
...
}catch (e56933){var _e__56355__auto__ = e56933;
return false;
}})())){
...
var vec__56938 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56938,(0),null);
...
var len__4864__auto___57223 = arguments.length;
var i__4865__auto___57224 = (0);
while(true){
if((i__4865__auto___57224 < len__4864__auto___57223)){
args__4870__auto__.push((arguments[i__4865__auto___57224]));

var G__57225 = (i__4865__auto___57224 + (1));
i__4865__auto___57224 = G__57225;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__56990){
var vec__56991 = p__56990;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56991,(0),null);
...
var G__57229 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__57230 = cljs.core.butlast(remaining_tokens);
name_tokens = G__57229;
remaining_tokens = G__57230;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq56985){
var G__56986 = cljs.core.first(seq56985);
var seq56985__$1 = cljs.core.next(seq56985);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__56986,seq56985__$1);
}));
...
var vec__56996 = cljs.core.split_with((function (p1__56995_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__56995_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56996,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56996,(1),null);
...
var vec__57004 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57004,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57004,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__57234 = cljs.core.rest(remaining_tokens);
var G__57235 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__57234;
name_tokens = G__57235;
continue;
} else {
...
var vec__57026 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57026,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57026,(1),null);
var vec__57029 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57029,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57029,(1),null);
var vec__57032 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57032,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57032,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57032,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57032,(3),null);
...
var vec__57038 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57038,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57038,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57038,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57038,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57038,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57038,(5),null);
...
if(cljs.core.truth_(temp__5751__auto__)){
var vec__57042 = temp__5751__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57042,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57042,(1),null);
var vec__57045 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57045,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57045,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__57049 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__57049) : devtools.munging.parse_fn_info_deep.call(null,G__57049));
})()));
}
} else {
return fn_info;
...
var G__57266 = (arity + (1));
var G__57267 = (function (){var temp__5751__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5751__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__57058){
var vec__57059 = p__57058;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57059,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57059,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__57068_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__57068_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__57069_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__57069_SHARP_);
}),sorted_infos);
...
var args__4870__auto__ = [];
var len__4864__auto___57279 = arguments.length;
var i__4865__auto___57280 = (0);
while(true){
if((i__4865__auto___57280 < len__4864__auto___57279)){
args__4870__auto__.push((arguments[i__4865__auto___57280]));

var G__57281 = (i__4865__auto___57280 + (1));
i__4865__auto___57280 = G__57281;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__57078){
var vec__57079 = p__57078;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57079,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq57070){
var G__57072 = cljs.core.first(seq57070);
var seq57070__$1 = cljs.core.next(seq57070);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57072,seq57070__$1);
}));
...
var map__57124 = options;
var map__57124__$1 = cljs.core.__destructure_map(map__57124);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57124__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57124__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57124__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57124__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__57125 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57125,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57125,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57125,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57125,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57125,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57125,(5),null);
...
var o__56324__auto__ = f;
return (o__56324__auto__["getBasis"]).call(o__56324__auto__);
});
/**
...
}catch (e57161){var _e__56355__auto__ = e57161;
...
var G__57308 = (obj[cljs.core.first(path)]);
var G__57309 = cljs.core.rest(path);
obj = G__57308;
path = G__57309;
continue;
} else {
...
var _STAR_ = (function (accum,p__57182){
var vec__57183 = p__57182;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57183,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57183,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__57190){
var vec__57191 = p__57190;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57191,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57191,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57191,(2),null);
...
var post_process = (function (p__57195){
var vec__57196 = p__57195;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57196,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57196,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__57194_SHARP_){
return (obj[cljs.core.first(p1__57194_SHARP_)]);
}),sorted_matches);
