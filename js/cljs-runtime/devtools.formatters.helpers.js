...
var G__58360 = devtools.prefs.pref(v);
v = G__58360;
continue;
} else {
return v;
...
}catch (e58311){var _e__56355__auto__ = e58311;
return false;
}})();
...
}catch (e58326){var _e__56355__auto__ = e58326;
return false;
}})();
...
}catch (e58332){var _e__56355__auto__ = e58332;
return false;
}}
}
});
...
var vec__58352 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58352,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58352,(1),null);
...
return cljs.core.some((function (p1__58355_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__58355_SHARP_);
}),template);
});
