...
if((c === "\n")){
var G__69121 = escape_QMARK_;
var G__69122 = rewrite_clj.parser.string.flush_into(lines,buf);
escape_QMARK_ = G__69121;
lines = G__69122;
continue;
} else {
buf.append(c);

var G__69124 = ((cljs.core.not(escape_QMARK_)) && ((c === "\\")));
var G__69125 = lines;
escape_QMARK_ = G__69124;
lines = G__69125;
continue;
