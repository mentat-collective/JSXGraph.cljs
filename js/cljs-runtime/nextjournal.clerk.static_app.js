...
nextjournal.clerk.static_app.doc_url = (function nextjournal$clerk$static_app$doc_url(p__77943,path){
var map__77944 = p__77943;
var map__77944__$1 = cljs.core.__destructure_map(map__77944);
var path__GT_url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77944__$1,new cljs.core.Keyword(null,"path->url","path->url",619884785));
var current_path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77944__$1,new cljs.core.Keyword(null,"current-path","current-path",-113759954));
var bundle_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77944__$1,new cljs.core.Keyword(null,"bundle?","bundle?",-35631730));
...
var url__$1 = (function (){var G__77947 = url;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__77947),"index.html"].join('');
} else {
return G__77947;
}
})();
...
nextjournal.clerk.static_app.show = (function nextjournal$clerk$static_app$show(p__77958){
var map__77959 = p__77958;
var map__77959__$1 = cljs.core.__destructure_map(map__77959);
var view_data = map__77959__$1;
var sha = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77959__$1,new cljs.core.Keyword("git","sha","git/sha",-950222993));
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77959__$1,new cljs.core.Keyword("git","url","git/url",276391304));
var doc = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77959__$1,new cljs.core.Keyword(null,"doc","doc",1913296891));
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77959__$1,new cljs.core.Keyword(null,"path","path",-188191168));
var url__GT_path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77959__$1,new cljs.core.Keyword(null,"url->path","url->path",1929246367));
...
nextjournal.clerk.sci_viewer.set_state(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"doc","doc",1913296891),(function (){var G__77967 = doc;
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__77967,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("nextjournal","value","nextjournal/value",-1912768947),new cljs.core.Keyword(null,"blocks","blocks",-610462153)], null),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.into,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [nextjournal.clerk.static_app.hiccup(header)], null)));
} else {
return G__77967;
}
})()], null));
...
nextjournal.clerk.static_app.index = (function nextjournal$clerk$static_app$index(p__77969){
var map__77970 = p__77969;
var map__77970__$1 = cljs.core.__destructure_map(map__77970);
var view_data = map__77970__$1;
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77970__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
if((typeof document !== 'undefined')){
(document.title = "Clerk");
} else {
}

var with_let77971 = reagent.ratom.with_let_values(new cljs.core.Keyword(null,"with-let77971","with-let77971",252107206));
var temp__5757__auto___77979 = reagent.ratom._STAR_ratom_context_STAR_;
if((temp__5757__auto___77979 == null)){
} else {
var c__62567__auto___77980 = temp__5757__auto___77979;
if((with_let77971.generation === c__62567__auto___77980.ratomGeneration)){
...
(with_let77971.generation = c__62567__auto___77980.ratomGeneration);
}

var init77972 = (with_let77971.length === (0));
var _BANG_state = ((((init77972) || (cljs.core.not(with_let77971.hasOwnProperty((0))))))?(with_let77971[(0)] = reagent.core.atom.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"dark-mode?","dark-mode?",2063785096),nextjournal.ui.components.localstorage.get_item(nextjournal.clerk.sci_viewer.local_storage_dark_mode_key)], null))):(with_let77971[(0)]));
var ref_fn = ((((init77972) || (cljs.core.not(with_let77971.hasOwnProperty((1))))))?(with_let77971[(1)] = (function (p1__77968_SHARP_){
if(cljs.core.truth_(p1__77968_SHARP_)){
return nextjournal.clerk.sci_viewer.setup_dark_mode_BANG_(_BANG_state);
} else {
return null;
}
})):(with_let77971[(1)]));
var res77973 = new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.bg-gray-100.dark:bg-gray-900.flex.justify-center.overflow-y-auto.w-screen.h-screen.p-4.md:p-0","div.bg-gray-100.dark:bg-gray-900.flex.justify-center.overflow-y-auto.w-screen.h-screen.p-4.md:p-0",-28305780),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"ref","ref",1289896967),ref_fn], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.fixed.top-2.left-2.md:left-auto.md:right-2.z-10","div.fixed.top-2.left-2.md:left-auto.md:right-2.z-10",-1924941252),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [nextjournal.clerk.sci_viewer.dark_mode_toggle,_BANG_state], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.md:my-12.w-full.md:max-w-lg","div.md:my-12.w-full.md:max-w-lg",94095376),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.bg-white.dark:bg-gray-800.shadow-lg.rounded-lg.border.dark:border-gray-800.dark:text-white","div.bg-white.dark:bg-gray-800.shadow-lg.rounded-lg.border.dark:border-gray-800.dark:text-white",775975420),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.px-4.md:px-8.py-3","div.px-4.md:px-8.py-3",-415507650),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"h1.text-xl","h1.text-xl",-128714254),"Clerk"], null)], null),cljs.core.into.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ul","ul",-1349521403)], null),cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (path){
...
var map__77974 = cljs.core.deref(nextjournal.clerk.static_app._BANG_match);
var map__77974__$1 = cljs.core.__destructure_map(map__77974);
var match = map__77974__$1;
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77974__$1,new cljs.core.Keyword(null,"data","data",-232669377));
var path_params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77974__$1,new cljs.core.Keyword(null,"path-params","path-params",-48130597));
var map__77975 = data;
var map__77975__$1 = cljs.core.__destructure_map(map__77975);
var view = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77975__$1,new cljs.core.Keyword(null,"view","view",1247994814));
...
nextjournal.clerk.static_app.init = (function nextjournal$clerk$static_app$init(p__77977){
var map__77978 = p__77977;
var map__77978__$1 = cljs.core.__destructure_map(map__77978);
var state = map__77978__$1;
var bundle_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77978__$1,new cljs.core.Keyword(null,"bundle?","bundle?",-35631730));
var path__GT_doc = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77978__$1,new cljs.core.Keyword(null,"path->doc","path->doc",-634415134));
var path__GT_url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77978__$1,new cljs.core.Keyword(null,"path->url","path->url",619884785));
var current_path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77978__$1,new cljs.core.Keyword(null,"current-path","current-path",-113759954));
...
if(cljs.core.truth_(bundle_QMARK_)){
var router_77982 = reitit.frontend.router.cljs$core$IFn$_invoke$arity$1(nextjournal.clerk.static_app.get_routes(url__GT_doc));
reitit.frontend.easy.start_BANG_(router_77982,(function (p1__77976_SHARP_){
return cljs.core.reset_BANG_(nextjournal.clerk.static_app._BANG_match,p1__77976_SHARP_);
