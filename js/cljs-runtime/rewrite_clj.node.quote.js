...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4504__auto__,k68845,else__4505__auto__){
var self__ = this;
var this__4504__auto____$1 = this;
var G__68853 = k68845;
var G__68853__$1 = (((G__68853 instanceof cljs.core.Keyword))?G__68853.fqn:null);
switch (G__68853__$1) {
case "tag":
return self__.tag;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k68845,else__4505__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4525__auto__,p__68854){
var vec__68855 = p__68854;
var k__4526__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68855,(0),null);
var v__4527__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68855,(1),null);
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__68844){
var self__ = this;
var G__68844__$1 = this;
return (new cljs.core.RecordIter((0),G__68844__$1,4,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tag","tag",-1290361223),new cljs.core.Keyword(null,"prefix","prefix",-265908465),new cljs.core.Keyword(null,"sym","sym",-1444860305),new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this68846,other68847){
var self__ = this;
var this68846__$1 = this;
return (((!((other68847 == null)))) && ((((this68846__$1.constructor === other68847.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this68846__$1.tag,other68847.tag)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this68846__$1.prefix,other68847.prefix)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this68846__$1.sym,other68847.sym)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this68846__$1.children,other68847.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this68846__$1.__extmap,other68847.__extmap)))))))))))));
}));
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4509__auto__,k68845){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k68845);

}
}));

(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4510__auto__,k__4511__auto__,G__68844){
var self__ = this;
var this__4510__auto____$1 = this;
var pred__68865 = cljs.core.keyword_identical_QMARK_;
var expr__68866 = k__4511__auto__;
if(cljs.core.truth_((pred__68865.cljs$core$IFn$_invoke$arity$2 ? pred__68865.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__68866) : pred__68865.call(null,new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__68866)))){
return (new rewrite_clj.node.quote.QuoteNode(G__68844,self__.prefix,self__.sym,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__68865.cljs$core$IFn$_invoke$arity$2 ? pred__68865.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"prefix","prefix",-265908465),expr__68866) : pred__68865.call(null,new cljs.core.Keyword(null,"prefix","prefix",-265908465),expr__68866)))){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,G__68844,self__.sym,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__68865.cljs$core$IFn$_invoke$arity$2 ? pred__68865.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"sym","sym",-1444860305),expr__68866) : pred__68865.call(null,new cljs.core.Keyword(null,"sym","sym",-1444860305),expr__68866)))){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,G__68844,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__68865.cljs$core$IFn$_invoke$arity$2 ? pred__68865.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__68866) : pred__68865.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__68866)))){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,G__68844,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4511__auto__,G__68844),null));
}
}
}
}
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4501__auto__,G__68844){
var self__ = this;
var this__4501__auto____$1 = this;
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,self__.children,G__68844,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.quote.map__GT_QuoteNode = (function rewrite_clj$node$quote$map__GT_QuoteNode(G__68849){
var extmap__4542__auto__ = (function (){var G__68880 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__68849,new cljs.core.Keyword(null,"tag","tag",-1290361223),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"prefix","prefix",-265908465),new cljs.core.Keyword(null,"sym","sym",-1444860305),new cljs.core.Keyword(null,"children","children",-940561982)], 0));
if(cljs.core.record_QMARK_(G__68849)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__68880);
} else {
return G__68880;
}
})();
return (new rewrite_clj.node.quote.QuoteNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__68849),new cljs.core.Keyword(null,"prefix","prefix",-265908465).cljs$core$IFn$_invoke$arity$1(G__68849),new cljs.core.Keyword(null,"sym","sym",-1444860305).cljs$core$IFn$_invoke$arity$1(G__68849),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__68849),null,cljs.core.not_empty(extmap__4542__auto__),null));
});
...
var G__68976 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__68976;
continue;
}
break;
...
var G__68977 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__68977;
continue;
}
break;
...
var G__68978 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__68978;
continue;
}
break;
...
var G__68979 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__68979;
continue;
}
break;
