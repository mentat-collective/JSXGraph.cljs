...
var map__67384 = cljs.core.meta(iobj);
var map__67384__$1 = cljs.core.__destructure_map(map__67384);
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67384__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67384__$1,new cljs.core.Keyword(null,"column","column",2078222095));
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__67384__$1,new cljs.core.Keyword(null,"file","file",-1269645878),cljs.core.deref(sci.impl.utils.current_file));
...
var map__67395 = (function (){var or__4253__auto__ = stack;
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
} else {
var G__67396 = env;
var G__67396__$1 = (((G__67396 == null))?null:cljs.core.deref(G__67396));
var G__67396__$2 = (((G__67396__$1 == null))?null:new cljs.core.Keyword("sci.impl","callstack","sci.impl/callstack",-1621010557).cljs$core$IFn$_invoke$arity$1(G__67396__$1));
var G__67396__$3 = (((G__67396__$2 == null))?null:cljs.core.get.cljs$core$IFn$_invoke$arity$2(G__67396__$2,id));
var G__67396__$4 = (((G__67396__$3 == null))?null:cljs.core.deref(G__67396__$3));
var G__67396__$5 = (((G__67396__$4 == null))?null:cljs.core.last(G__67396__$4));
if((G__67396__$5 == null)){
return null;
} else {
return cljs.core.meta(G__67396__$5);
}
}
})();
var map__67395__$1 = cljs.core.__destructure_map(map__67395);
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67395__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67395__$1,new cljs.core.Keyword(null,"column","column",2078222095));
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67395__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
var new_exception = (function (){var new_d = (function (){var G__67398 = new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword("sci","error","sci/error",-979082803),new cljs.core.Keyword(null,"line","line",212345235),line,new cljs.core.Keyword(null,"column","column",2078222095),column,new cljs.core.Keyword(null,"message","message",-406056002),ex_msg__$1,new cljs.core.Keyword("sci.impl","callstack","sci.impl/callstack",-1621010557),st,new cljs.core.Keyword(null,"file","file",-1269645878),file], null);
if(cljs.core.truth_(phase)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__67398,new cljs.core.Keyword(null,"phase","phase",575722892),phase);
} else {
return G__67398;
}
})();
...
var len__4864__auto___67465 = arguments.length;
var i__4865__auto___67466 = (0);
while(true){
if((i__4865__auto___67466 < len__4864__auto___67465)){
args__4870__auto__.push((arguments[i__4865__auto___67466]));

var G__67467 = (i__4865__auto___67466 + (1));
i__4865__auto___67466 = G__67467;
continue;
} else {
}
break;
...
/** @this {Function} */
(sci.impl.utils.vary_meta_STAR_.cljs$lang$applyTo = (function (seq67401){
...
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__67402,G__67403,seq67401__$2);
}));

sci.impl.utils.strip_core_ns = (function sci$impl$utils$strip_core_ns(sym){
var G__67409 = cljs.core.namespace(sym);
switch (G__67409) {
case "clojure.core":
case "cljs.core":
...
var fexpr__67416 = cljs.core.deref(sci.impl.utils.eval_form_state);
return (fexpr__67416.cljs$core$IFn$_invoke$arity$2 ? fexpr__67416.cljs$core$IFn$_invoke$arity$2(sci_ctx,form) : fexpr__67416.call(null,sci_ctx,form));
});
/**
...
var run = cljs.core.cons(fst,cljs.core.take_while.cljs$core$IFn$_invoke$arity$2((function (p1__67417_SHARP_){
return f(p1__67417_SHARP_);
}),cljs.core.next(s)));
return cljs.core.cons(run,(function (){var G__67418 = pred;
var G__67419 = (new cljs.core.LazySeq(null,(function (){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2(cljs.core.count(run),s);
}),null,null));
return (sci.impl.utils.split_when.cljs$core$IFn$_invoke$arity$2 ? sci.impl.utils.split_when.cljs$core$IFn$_invoke$arity$2(G__67418,G__67419) : sci.impl.utils.split_when.call(null,G__67418,G__67419));
})());
} else {
return null;
}
...
var G__67475 = cljs.core.next(params__$1);
var G__67476 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new_params,cljs.core.first(params__$1));
var G__67477 = lets;
params__$1 = G__67475;
new_params = G__67476;
lets = G__67477;
...
var G__67478 = cljs.core.next(params__$1);
var G__67479 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new_params,gparam);
var G__67480 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(lets,cljs.core.first(params__$1)),gparam);
params__$1 = G__67478;
new_params = G__67479;
lets = G__67480;
continue;
...
var G__67432 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(expr_meta,new cljs.core.Keyword(null,"ns","ns",441598760),cljs.core.deref(sci.impl.utils.current_ns),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"file","file",-1269645878),cljs.core.deref(sci.impl.utils.current_file)], 0));
if(cljs.core.truth_(special_QMARK_)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__67432,new cljs.core.Keyword(null,"special","special",-1125941630),true);
} else {
return G__67432;
}
}));
...
var args__4870__auto__ = [];
var len__4864__auto___67482 = arguments.length;
var i__4865__auto___67483 = (0);
while(true){
if((i__4865__auto___67483 < len__4864__auto___67482)){
args__4870__auto__.push((arguments[i__4865__auto___67483]));

var G__67485 = (i__4865__auto___67483 + (1));
i__4865__auto___67483 = G__67485;
continue;
} else {
}
break;
...
/** @this {Function} */
(sci.impl.utils.log.cljs$lang$applyTo = (function (seq67433){
var self__4852__auto__ = this;
return self__4852__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq67433));
}));
...
sci.impl.utils.current_file = sci.impl.utils.dynamic_var.cljs$core$IFn$_invoke$arity$3(new cljs.core.Symbol(null,"*file*","*file*",624866474,null),null,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"ns","ns",441598760),sci.impl.utils.clojure_core_ns], null));
sci.impl.utils.current_ns = sci.impl.utils.dynamic_var.cljs$core$IFn$_invoke$arity$3(new cljs.core.Symbol(null,"*ns*","*ns*",740153818,null),sci.impl.utils.user_ns,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"ns","ns",441598760),sci.impl.utils.clojure_core_ns], null));
...
var G__67441 = sci.impl.utils.new_var.cljs$core$IFn$_invoke$arity$4(name,null,null,false);
sci.impl.vars.unbind(G__67441);
