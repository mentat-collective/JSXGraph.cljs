...
var G__63744 = o;
reagent.impl.template.goog$module$goog$object.set(G__63744,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__63779__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__63779 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__63780__i = 0, G__63780__a = new Array(arguments.length -  0);
while (G__63780__i < G__63780__a.length) {G__63780__a[G__63780__i] = arguments[G__63780__i + 0]; ++G__63780__i;}
  args = new cljs.core.IndexedSeq(G__63780__a,0,null);
} 
return G__63779__delegate.call(this,args);};
G__63779.cljs$lang$maxFixedArity = 0;
G__63779.cljs$lang$applyTo = (function (arglist__63781){
var args = cljs.core.seq(arglist__63781);
return G__63779__delegate(args);
});
...
var G__63745 = o;
reagent.impl.template.goog$module$goog$object.set(G__63745,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__63784__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__63784 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__63785__i = 0, G__63785__a = new Array(arguments.length -  0);
while (G__63785__i < G__63785__a.length) {G__63785__a[G__63785__i] = arguments[G__63785__i + 0]; ++G__63785__i;}
  args = new cljs.core.IndexedSeq(G__63785__a,0,null);
} 
return G__63784__delegate.call(this,args);};
G__63784.cljs$lang$maxFixedArity = 0;
G__63784.cljs$lang$applyTo = (function (arglist__63786){
var args = cljs.core.seq(arglist__63786);
return G__63784__delegate(args);
});
G__63784.cljs$core$IFn$_invoke$arity$variadic = G__63784__delegate;
return G__63784;
})()
;
} else {
...
var G__63746 = props;
var G__63746__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__63746,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__63746);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__63746__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4253__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__63747 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__63747,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__63747;
}
})(),id_class);
...
var G__63748 = (cljs.core.count(argv) - first_child);
switch (G__63748) {
case (0):
...
var vec__63749 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63749,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63749,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63749,(2),null);
...
var temp__5757__auto___63799 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___63799 == null)){
} else {
var key_63800 = temp__5757__auto___63799;
(jsprops.key = key_63800);
}
...
var temp__5757__auto___63801 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___63801 == null)){
} else {
var key_63802 = temp__5757__auto___63801;
(jsprops.key = key_63802);
}
...
var temp__5757__auto___63806 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___63806 == null)){
} else {
var key_63809 = temp__5757__auto___63806;
(jsprops.key = key_63809);
}
...
var temp__5757__auto___63813 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___63813 == null)){
} else {
var key_63818 = temp__5757__auto___63813;
...
var temp__5757__auto___63820 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___63820 == null)){
} else {
var key_63821 = temp__5757__auto___63820;
(jsprops.key = key_63821);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__63755_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__63755_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__63756 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63756,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63756,(1),null);
...
break;
default:
var G__63823 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__63824 = compiler;
v = G__63823;
compiler = G__63824;
continue;
...
var G__63768 = tag;
var G__63768__$1 = (((G__63768 instanceof cljs.core.Keyword))?G__63768.fqn:null);
switch (G__63768__$1) {
case ">":
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template63772 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template63772 = (function (opts,id,fn_to_element,parse_fn,meta63773){
this.opts = opts;
this.id = id;
this.fn_to_element = fn_to_element;
this.parse_fn = parse_fn;
this.meta63773 = meta63773;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(reagent.impl.template.t_reagent$impl$template63772.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_63774,meta63773__$1){
var self__ = this;
var _63774__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template63772(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta63773__$1));
}));

(reagent.impl.template.t_reagent$impl$template63772.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_63774){
var self__ = this;
var _63774__$1 = this;
return self__.meta63773;
}));

(reagent.impl.template.t_reagent$impl$template63772.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template63772.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template63772.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template63772.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template63772.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template63772.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta63773","meta63773",-64326996,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template63772.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template63772.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template63772");

(reagent.impl.template.t_reagent$impl$template63772.cljs$lang$ctorPrWriter = (function (this__4491__auto__,writer__4492__auto__,opt__4493__auto__){
return cljs.core._write(writer__4492__auto__,"reagent.impl.template/t_reagent$impl$template63772");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template63772.
 */
reagent.impl.template.__GT_t_reagent$impl$template63772 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template63772(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta63773){
return (new reagent.impl.template.t_reagent$impl$template63772(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta63773));
});

}

return (new reagent.impl.template.t_reagent$impl$template63772(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
