...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_51684 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_51684(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_51685 = (function (port,val,fn1_handler){
var x__4550__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_51685(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_51686 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_51686(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_51688 = (function (chan){
var x__4550__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_51688(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_51689 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_51689(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_51690 = (function (h){
var x__4550__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_51690(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_51696 = (function (h){
var x__4550__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_51696(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_51701 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_51701(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_51702 = (function (b){
var x__4550__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_51702(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_51704 = (function (b,itm){
var x__4550__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_51704(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_51709 = (function (b){
var x__4550__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_51709(b);
}
});
