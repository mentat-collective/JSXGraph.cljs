...
var G__69153 = cljs.core.subs.cljs$core$IFn$_invoke$arity$2(s__$1,(eol_ndx + cljs.core.count(m)));
var G__69154 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(lines,cljs.core.subs.cljs$core$IFn$_invoke$arity$3(s__$1,(0),eol_ndx));
s__$1 = G__69153;
lines = G__69154;
continue;
} else {
...
var comma_69155 = rewrite_clj.node.whitespace.whitespace_nodes(", ");
var space_69156 = rewrite_clj.node.whitespace.whitespace_node(" ");
rewrite_clj.node.coercer.map__GT_children = (function rewrite_clj$node$coercer$map__GT_children(m){
return cljs.core.vec(cljs.core.drop_last.cljs$core$IFn$_invoke$arity$2(cljs.core.count(comma_69155),cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__69142){
var vec__69147 = p__69142;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69147,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69147,(1),null);
return cljs.core.list_STAR_.cljs$core$IFn$_invoke$arity$4(rewrite_clj.node.protocols.coerce(k),space_69156,rewrite_clj.node.protocols.coerce(v),comma_69155);
...
return rewrite_clj.node.coercer.node_with_meta((function (){var G__69152 = cljs.core.vec(rewrite_clj.node.whitespace.space_separated(cljs.core.map.cljs$core$IFn$_invoke$arity$2(rewrite_clj.node.protocols.coerce,sq)));
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__69152) : f.call(null,G__69152));
})(),sq);
});
