...
var len__4864__auto___58597 = arguments.length;
var i__4865__auto___58598 = (0);
while(true){
if((i__4865__auto___58598 < len__4864__auto___58597)){
args__4870__auto__.push((arguments[i__4865__auto___58598]));

var G__58599 = (i__4865__auto___58598 + (1));
i__4865__auto___58598 = G__58599;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq58434){
...
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__58435,G__58436,seq58434__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__58466_SHARP_){
return (!((cljs.core.meta(p1__58466_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58529__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e58533){var _e__56355__auto__ = e58533;
return false;
}})();
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
...
}catch (e58541){var _e__56355__auto__ = e58541;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__58572 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__58573 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__58573);

try{var map__58577 = opts;
var map__58577__$1 = cljs.core.__destructure_map(map__58577);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58577__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__58572);
}});
...
var temp__5751__auto___58612 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5751__auto___58612)){
var managed_print_level_58613 = temp__5751__auto___58612;
var _STAR_print_level_STAR__orig_val__58583_58614 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__58584_58615 = managed_print_level_58613;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__58584_58615);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__58582_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__58582_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__58583_58614);
}} else {
job_fn();
}
