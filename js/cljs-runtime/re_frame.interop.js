...
return [(function (){var pred__63932 = cljs.core.instance_QMARK_;
var expr__63933 = reactive_val;
if(cljs.core.truth_((pred__63932.cljs$core$IFn$_invoke$arity$2 ? pred__63932.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__63933) : pred__63932.call(null,reagent.ratom.RAtom,expr__63933)))){
return "ra";
} else {
if(cljs.core.truth_((pred__63932.cljs$core$IFn$_invoke$arity$2 ? pred__63932.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__63933) : pred__63932.call(null,reagent.ratom.RCursor,expr__63933)))){
return "rc";
} else {
if(cljs.core.truth_((pred__63932.cljs$core$IFn$_invoke$arity$2 ? pred__63932.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__63933) : pred__63932.call(null,reagent.ratom.Reaction,expr__63933)))){
return "rx";
} else {
if(cljs.core.truth_((pred__63932.cljs$core$IFn$_invoke$arity$2 ? pred__63932.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__63933) : pred__63932.call(null,reagent.ratom.Track,expr__63933)))){
return "tr";
} else {
return "other";
}
...
var _STAR_in_batch_QMARK__STAR__orig_val__63941 = re_frame.interop._STAR_in_batch_QMARK__STAR_;
var _STAR_in_batch_QMARK__STAR__temp_val__63942 = true;
(re_frame.interop._STAR_in_batch_QMARK__STAR_ = _STAR_in_batch_QMARK__STAR__temp_val__63942);

try{return (f.cljs$core$IFn$_invoke$arity$0 ? f.cljs$core$IFn$_invoke$arity$0() : f.call(null));
}finally {(re_frame.interop._STAR_in_batch_QMARK__STAR_ = _STAR_in_batch_QMARK__STAR__orig_val__63941);
}}));
});
var flush_queues_63954 = reagent.impl.batching.render_queue.flush_queues.bind(reagent.impl.batching.render_queue);
(reagent.impl.batching.render_queue.flush_queues = (function (){
return re_frame.interop.batch_updates(flush_queues_63954);
}));
var queue_render_63955 = reagent.impl.batching.queue_render;
(reagent.impl.batching.queue_render = (function (c){
if(cljs.core.truth_(re_frame.interop._STAR_in_batch_QMARK__STAR_)){
return c.forceUpdate();
} else {
return (queue_render_63955.cljs$core$IFn$_invoke$arity$1 ? queue_render_63955.cljs$core$IFn$_invoke$arity$1(c) : queue_render_63955.call(null,c));
}
}));
