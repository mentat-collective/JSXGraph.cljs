...
var len__4864__auto___58255 = arguments.length;
var i__4865__auto___58256 = (0);
while(true){
if((i__4865__auto___58256 < len__4864__auto___58255)){
args__4870__auto__.push((arguments[i__4865__auto___58256]));

var G__58257 = (i__4865__auto___58256 + (1));
i__4865__auto___58256 = G__58257;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq58222){
var G__58223 = cljs.core.first(seq58222);
var seq58222__$1 = cljs.core.next(seq58222);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__58223,seq58222__$1);
}));
...
return cljs.core.some((function (p1__58230_SHARP_){
return (p1__58230_SHARP_ === object);
}),history);
});
