...
var G__61735 = next_offset;
var G__61736 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(res,cur_char);
offset__$1 = G__61735;
res = G__61736;
continue;
}
...
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__61603_SHARP_){
return ["%",lambdaisland.uri.platform.byte__GT_hex(p1__61603_SHARP_)].join('');
...
var encode_char = (function (p1__61610_SHARP_){
var G__61621 = p1__61610_SHARP_;
if(cljs.core.truth_(cljs.core.re_find(char_class,p1__61610_SHARP_))){
return lambdaisland.uri.normalize.percent_encode.cljs$core$IFn$_invoke$arity$1(G__61621);
} else {
return G__61621;
}
});
...
return clojure.string.replace(s,/(%[0-9A-Fa-f]{2})+/,(function (p__61640){
var vec__61641 = p__61640;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61641,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61641,(1),null);
...
var G__61753 = (i + (3));
var G__61754 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(res,lambdaisland.uri.normalize.percent_encode.cljs$core$IFn$_invoke$arity$2(lambdaisland.uri.normalize.percent_decode(cljs.core.subs.cljs$core$IFn$_invoke$arity$3(s,i,(i + (3)))),new cljs.core.Keyword(null,"query","query",-1288509510)));
i = G__61753;
res = G__61754;
continue;
} else {
...
var G__61756 = (i + (1));
var G__61757 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(res,cljs.core.subs.cljs$core$IFn$_invoke$arity$3(s,i,(i + (1))));
i = G__61756;
res = G__61757;
continue;
} else {
var increment = ((lambdaisland.uri.normalize.high_surrogate_QMARK_(lambdaisland.uri.platform.char_code_at(s,i)))?(2):(1));
var G__61758 = (i + increment);
var G__61759 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(res,lambdaisland.uri.normalize.percent_encode.cljs$core$IFn$_invoke$arity$2(cljs.core.subs.cljs$core$IFn$_invoke$arity$3(s,i,(i + increment)),new cljs.core.Keyword(null,"query","query",-1288509510)));
i = G__61758;
res = G__61759;
continue;
